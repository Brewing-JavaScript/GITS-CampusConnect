...
const Room = () => {
  ...
  const handleIncommitCall = useCallback(
    async ({ from, offer }) => {
      setRemoteSocketId(from);
  ...
  return (
    <div className="room-container bg-blue-100 p-4 rounded-md shadow-lg">
      <div className="video-container grid grid-cols-2 gap-4 relative">
        <div className="local-video border w-40 h-30 border-gray-300 rounded-md overflow-hidden flex justify-center items-center">
          {myStream && (
            <ReactPlayer
        ...
        <div className="remote-video border border-gray-300 rounded-md overflow-hidden flex justify-center items-center">
          {remoteStream && (
            <ReactPlayer
              className="react-player"
              playing
      ...
      <div className="controls mt-4 flex justify-center">
        <button
          className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2 transition-colors duration-300"
